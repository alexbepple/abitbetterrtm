(function() {
	...
	css += '.abr-listtabs li{padding: 0px 2px; -moz-border-radius: 3px;}';
	...
	css += '.abr-taskdrag-helper{padding: 3px 8px; cursor:-moz-grabbing; -moz-box-shadow: 5px 5px 5px #888; color:black; background-color: lightblue;}';
